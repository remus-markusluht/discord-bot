...
exports.run = async (client, message) => {
    ...
    logEmbed.setThumbnail(message.author.displayAvatarURL({ dynamic: true, size: 1024 }))
    logEmbed.setFooter({ text: `${config.Locale.totalMessagesLog} ${client.tickets.get(`${message.channel.id}`, "messages")}`, iconURL: `${message.author.displayAvatarURL({ dynamic: true, size: 1024 })}` })
