...
module.exports = {
    ...
    async execute(interaction, client) {
        ...
        logEmbed.setFooter({ text: `${config.Locale.totalMessagesLog} ${client.tickets.get(`${interaction.channel.id}`, "messages")}`, iconURL: `${interaction.user.displayAvatarURL({ dynamic: true, size: 1024 })}` })
